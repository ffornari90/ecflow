...
///
/// @brief This is a type used to indicate that permissions are unrestricted
///
struct UnrestrictedRules
{
};

///
/// @brief This is a type used to indicate that permissions are derived from the Defs nodes (as per ECF_PERMISSIONS)
///
struct NodeRules
{
};
...
///
/// @bried This is a type used to indicate that permissions are derived from a white list file
///
